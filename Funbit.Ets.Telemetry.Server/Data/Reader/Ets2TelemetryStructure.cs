...
namespace Funbit.Ets.Telemetry.Server.Data.Reader
{
    ...
    internal struct Ets2TelemetryStructure
    {
        ...
        string displayString;
            displayString = $@"gear:{gear},gearsForward:{gearsForward},gearRanges:{gearRanges},gearRangeActive:{gearRangeActive},
                               engineEnabled:{engineEnabled},engineRpm:{engineRpm},engineRpmMax:{engineRpmMax},
                               fuel:{fuel},fuelCapacity:{fuelCapacity},fuelRate;{fuelRate},fuelAvgConsumption:{fuelAvgConsumption},
                               gameSteer:{gameSteer},gameThrottle:{gameThrottle},gameBrake:{gameBrake},gameClutch:{gameClutch},
                               userSteer:{userSteer},userThrottle:{userThrottle},userBrake:{userBrake},userClutch:{userClutch},
                               airPressure:{airPressure},brakeTemperature:{brakeTemperature},fuelWarning:{fuelWarning},oilPressure:{oilPressure},
                               waterTemperature:{waterTemperature},batteryVoltage:{batteryVoltage},truckOdometer:{truckOdometer},cruiseControlSpeed:{cruiseControlSpeed}";
